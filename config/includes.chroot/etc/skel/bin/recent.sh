...
pre='    <item icon=\"/usr/share/icons/gnome/256x256/emotes/stock_smiley-5.png\" label="'
mid='">
...
'"$files"'
<separator />
    <item icon="/usr/share/icons/gnome/256x256/emotes/stock_smiley-15.png" label="Clear Recent Files">
        <action name="Execute">
            <command>
            &apos;'"$0"'&apos; --clear
            </command>
