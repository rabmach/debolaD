...
try: #automatic theme selection
	...
	selected_theme = "Papirus" #fallback theme

selected_theme = "Papirus" # direct theme selection, don't make it hicolor.   ***** SOME DISTRIBUTIONS REQUIRES THIS OPTION UNCOMMENTED.
...
terminal_string = "x-terminal-emulator"         # your favourites terminal exec string
